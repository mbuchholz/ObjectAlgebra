...
\hypersetup{
	pdftitle = {Object Algebra - An approach of the Expression Problem},
...
%
\titlerunning{Object Algebra - An approach of the Expression Problem}  % abbreviated title (for running head)
