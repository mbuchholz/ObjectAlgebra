...
public partial class ArithmeticLexer : Lexer {
	...
	public static readonly string[] ruleNames = {
		"LPAREN", "RPAREN", "PLUS", "MINUS", "NUMBER", "WS"
	};
